...
Pi-symphony runs unattended. Treat the planner's chosen approach as approved unless it violates WORKFLOW.md's blocker criteria. Do not pause for human approval on routine implementation decisions; document assumptions and continue.
