    ...
    <div className="bg-white border-b border-gray-200 px-3 py-3 sm:px-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <button
          ...
          className="inline-flex items-center px-3 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium transition-colors sm:px-4"
          type="button"
        >
          <svg
        ...
        {/* Status indicator */}
        <div className="hidden min-[880px]:block">{statusElement}</div>

        <div className="flex flex-wrap items-center gap-2 justify-end">
          {showPropertiesButton && onOpenProperties && (
            <button
          ...
          <button
            ...
            className={`inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium transition-colors sm:px-4 ${saveButtonClass}`}
            type="button"
          >
            {isSaving ? (
              <>
          ...
          <button
            ...
            className={`inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium transition-colors sm:px-4 ${compositeButtonClass}`}
            type="button"
          >
            {isCompositing ? (
              <>
      ...
      <div className="mt-3 min-[880px]:hidden">{statusElement}</div>
    </div>
  );
}
