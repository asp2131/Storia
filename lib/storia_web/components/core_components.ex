defmodule StoriaWeb.CoreComponents do
  @moduledoc """
  ...
  the closing/cancel event, for example:
      ...
      <.modal id="confirm" on_cancel={JS.navigate(~p"/library")}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StoriaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StoriaWeb.Gettext, "errors", msg, opts)
    end
  end
