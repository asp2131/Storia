defmodule StoriaWeb.UserAuth do
  ...
  @max_age 30 * 24 * 60 * 60
  @remember_me_cookie "_storia_web_user_remember_me"
  ...
  the current_user:
      ...
      defmodule StoriaWeb.PageLive do
        use StoriaWeb, :live_view

        on_mount {StoriaWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{StoriaWeb.UserAuth, :ensure_authenticated}] do
